...
PERCHE' NON E' UN DETTAGLIO. Il 27 agosto quello scarto era stato
diagnosticato come "tre celle stantie" e la griglia era stata rifatta.
Oggi il valore vecchio si e' riprodotto alla quarta cifra da uno script
...
IPOTESI GIA' ESCLUSE
  ...
  file dei latenti   `latents_..._casuale.pt` non cambia dal 24 agosto.
